...
#   	echo $fileName;
# 	cmd=$(printf "$WGET $mO vgaVideos/$fileName http://domedb.perception.cs.cmu.edu/webdata/dataset/$datasetName/videos/vga_shared_crf10/$fileName || rm -v vgaVideos/$fileName")
# 	eval $cmd
# done
