...
_C.MODEL.PRETRAINED = ''
_C.MODEL.WEIGHT_2D = './weights/hrnet/panoptic_from_mpii/w32_384x288_adam_lr1e-3.pth'
...
_C.MODEL.WEIGHT_3D = "./weights/simple_baseline/model_best_hd.pth"
_C.MODEL.OUTPUT_3D_WORLD = False
...
# for combined model (2D + 3D model)
_C.MODEL.WEIGHT_COMBINED = ""
